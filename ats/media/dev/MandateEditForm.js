/*
 * File: MandateEditForm.js
 * Date: Fri Aug 06 2010 00:51:01 GMT-0400 (EDT)
 * 
...
MandateEditForm = Ext.extend(MandateEditFormUi, {
    initComponent: function() {
        MandateEditForm.superclass.initComponent.call(this);
    ...
    ,onCreateClick: function( button, event ) {
        ...
        if( form.isValid() ){
            form.submit({
                url: '/ats/main/mandate/new/'
                ,scope: this
                ,waitMsg: 'Creating new mandate...'
                ,success: this.onSuccess
                ,failure: this.onFailure
            });
        }
...
Ext.reg('mandateeditform', MandateEditForm);
