/*
 * File: CandidateMACGridView.js
 * Date: Sun Apr 03 2011 22:58:41 GMT-0400 (EDT)
 * 
...
CandidateMACGridView = Ext.extend(CandidateMACGridViewUi, {
    constructor: function(cfg) {
        cfg = cfg || {};
        cfg["getRowClass"] = this.applyRowClass;
        CandidateMACGridView.superclass.constructor.call(this, Ext.apply({
        }, cfg));
    }
...
Ext.reg('candidatemacgridview', CandidateMACGridView);
