/*
 * File: MandateNewWindow.js
 * Date: Mon Aug 09 2010 01:28:34 GMT-0400 (EDT)
 * 
...
MandateNewWindow = Ext.extend(MandateNewWindowUi, {
    initComponent: function() {
        MandateNewWindow.superclass.initComponent.call(this);
    ...
    ,onSuccess: function( form, action ) {
        ...
        Ext.example.msg('Success','Mandate created correctly".');
        //Ext.Msg.show({
        //    title: 'Success'
        //    ,msg: 'Reload grid to see new mandate!'
        //    ,modal: true
        //    ,icon: Ext.Msg.INFO
        //    ,buttons: Ext.Msg.OK
        //});
        //close mandate new window
        this.close();
    }
...
Ext.reg('mandatenewwindow', MandateNewWindow);
